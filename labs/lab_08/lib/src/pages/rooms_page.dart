...
class _RoomsPageState extends State<RoomsPage> {
  List<ItemHabitacion> listaHabitaciones = [
    ItemHabitacion(false,
        const Image(height: 60, image: AssetImage('images/1bed.jpg'),),
        "Habitación grande",
        "Habitación con una cama tamaño King"
    ),
    ItemHabitacion(false,
        const Image(height: 60, image: AssetImage('images/2beds.jpg'),),
        "Habitación doble",
        "Habitación con dos camas, diseñada para dos personas."),
    ItemHabitacion(false,
        const Image(height: 60, image: AssetImage('images/3beds.jpg'),),
        "Habitación Familiar",
