...
class _HomePageState extends State<HomePage> {
  ...
  final _textStyleTitle = const TextStyle(fontSize: 17.0, color: Colors.deepOrange, fontWeight: FontWeight.bold);
  final _textStyleContent = const TextStyle(fontSize: 17.0, color: Colors.blue);
